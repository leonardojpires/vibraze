...
<nav class="navbar navbar-expand-lg navbar-light flex-column ms-auto">
    <div class="text-center mt-3 mb-3">
        <a class=" mb-3 fs-2" href="{{ route('home') }}"><img src="{{ asset('images/logo/vibraze_logo_letters_only.png') }}" alt="Vibraze" class="navbar-brand img-fluid w-50 zoom-hover"></a>
    </div>
    ...
    <div class="collapse navbar-collapse d-flex flex-column align-items-between justify-content-between flex-column" id="navbarSupportedContent">
